...
export default function Signup() {
    ...
    const setBtnBg = (ev)=> {
        ...
        if(loginProps.passRef.current.value.length>4) {
            signupBtn.style.backgroundColor = "mediumvioletred"
            signupBtn.style.cursor = "pointer"
            signupBtn.removeAttribute('disabled')
        }
        else {
            signupBtn.style.backgroundColor = "mediumorchid"
        ...
        <>
            ...
            <motion.div className="signupBox container" initial={{ opacity: 0, y: 150 }}
                ...
                <div className="container">
                    ...
                    <button type="submit" className="signupBtn" style={{cursor:"default"}} onClick={() => checkSignUp()} >Sign Up</button>

                </div>
                <div className="signupBtnCont" style={{ "display": "flex", "alignItems": "center", flexDirection: "column" }}>

                    <h6 className='text textShadow'>Existing User?</h6>
